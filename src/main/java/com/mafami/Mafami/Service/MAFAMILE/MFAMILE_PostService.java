...
public class MFAMILE_PostService {
	...
	public MAFAMILE_PostEntity save(MAFAMILE_PostEntity entity) {		return mAFAMILE_PostRepo.save(entity);		}
	
	public void delete(String id) {		mAFAMILE_PostRepo.delete(mAFAMILE_PostRepo.findOneById(id));		}
